...
const Home = () => {
  const {page, setPage, room, setRoom, players, setPlayers, market, setMarket, playedCards, setPlayedCards} = useContext(GameContext);
  const {username, balance, setLoggedIn} = useContext(UserContext);
  return ( 
    <div className="home">
      <Navbar username={username} balance={balance} setLoggedIn={setLoggedIn} setPage={setPage}/>
      <div className="homeContent">
        {page === "home" && <HomeContent setPage={setPage} username={username}/>}
        ...
        {page === "lobby" && <Lobby setPage={setPage} socket={socket} room={room} setRoom={setRoom} setPlayers={setPlayers} players={players} username={username} setMarket={setMarket} market={market} playedCards={playedCards} setPlayedCards={setPlayedCards} />}
